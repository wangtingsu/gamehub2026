...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-dark-900">
      <SEO
        title="关于 GameHub"
        description="GameHub 是一个专注于游戏爱好者的社区平台，致力于为玩家提供最好的游戏资讯、评测、交流和发现体验。"
        keywords="GameHub, 关于我们, 游戏社区, 游戏平台, 游戏资讯, 游戏评测, 官方社区"
      />
      {showFallback && (
      ...
      {/* 主要内容 */}
      <div className="py-12">
        <Title level={1} className="text-center mb-4 !text-gray-100">{hero?.title || '关于 GameHub'}</Title>
        <Paragraph className="text-lg text-center max-w-3xl mx-auto text-gray-400 mb-12">
          {hero?.description || 'GameHub 是一个专注于游戏爱好者的社区平台，致力于为玩家提供最好的游戏资讯、评测、交流和发现体验。'}
        </Paragraph>
        {/* 使命愿景 */}
        <Row gutter={[32, 32]} className="mb-16">
          <Col xs={24} lg={12}>
            <Card title={mission?.title || '我们的使命'} bordered={false} className="h-full">
              <Paragraph className="text-lg text-gray-300">
                {mission?.description || '连接每一位游戏爱好者，打造最纯粹、最热情的游戏社区。让每一位玩家都能在这里找到属于自己的游戏世界。'}
              </Paragraph>
            </Card>
          </Col>
          <Col xs={24} lg={12}>
            <Card title={vision?.title || '我们的愿景'} bordered={false} className="h-full">
              <Paragraph className="text-lg text-gray-300">
                {vision?.description || '成为全球最受信赖的游戏社区平台，让每一位玩家都能发现、分享和热爱游戏。'}
              </Paragraph>
            </Card>
          </Col>
        </Row>
        ...
        {values.length > 0 && (
          <div className="mb-16">
            <Title level={2} className="text-center mb-12">核心价值</Title>
            <Row gutter={[24, 24]}>
        ...
        {/* 发展历程 */}
        {timeline.length > 0 && (
          <Card title="发展历程" className="mb-16">
            <List
        ...
        {/* 联系我们 */}
        {contacts.length > 0 && (
          <Card title="联系我们" className="text-center">
        ...
        {showFallback && contacts.length === 0 && (
          <Card title="联系我们" className="text-center">
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} sm={8}>
                <div className="p-4">
                  <div className="text-2xl font-bold text-blue-600 mb-2">电子邮件</div>
                  <div className="text-gray-300">support@gghubs.com</div>
                </div>
              </Col>
              <Col xs={24} sm={8}>
                <div className="p-4">
                  <div className="text-2xl font-bold text-blue-600 mb-2">社区</div>
                  <div className="text-gray-300">加入我们的 Discord 社区</div>
                </div>
              </Col>
              <Col xs={24} sm={8}>
                <div className="p-4">
                  <div className="text-2xl font-bold text-blue-600 mb-2">商务合作</div>
